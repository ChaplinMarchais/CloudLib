...
```bash
CloudLib$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
CloudLib$ sam logs -n HelloWorldFunction --stack-name CloudLib --tail
```
...
```bash
CloudLib$ dotnet test test/HelloWorld.Test
```
